...
import { Team, Achievement } from './types';
...
export const INITIAL_ACHIEVEMENTS: Achievement[] = [
  { id: 'first_win', title: 'First Victory', description: 'Win your first match as a manager.', icon: '🥇', isUnlocked: false, condition: () => false }, // Handled manually
  { id: 'champion', title: 'Champion', description: 'Finish a season at rank #1.', icon: '👑', isUnlocked: false, condition: (h) => h.some(e => e.rank === 1) },
  { id: 'loyal', title: 'Club Legend', description: 'Complete 3 seasons with the same club.', icon: '🛡️', isUnlocked: false, condition: (h) => {
      const counts: Record<string, number> = {};
      h.forEach(e => counts[e.teamId] = (counts[e.teamId] || 0) + 1);
      return Object.values(counts).some(c => c >= 3);
  }},
  { id: 'journeyman', title: 'Journeyman', description: 'Manage 3 different clubs.', icon: '🌍', isUnlocked: false, condition: (h) => new Set(h.map(e => e.teamId)).size >= 3 },
  { id: 'dynasty', title: 'Dynasty', description: 'Win 3 trophies in your career.', icon: '🌟', isUnlocked: false, condition: (h) => h.filter(e => e.wonTrophy).length >= 3 },
];
...
export const SLIDE_IMPULSE = 5.5; // Reduced from 13.0 to ~5.5 (approx 60% reduction) to prevent flying too far
export const SLIDE_DURATION = 18; // ~0.3 seconds at 60fps
export const SLIDE_COOLDOWN = 150; // ~2.5 seconds
export const SLIDE_RECOVERY = 40; // ~0.66 seconds penalty
export const RECOVERY_SPEED_FACTOR = 0.3; // Much slower during recovery
...
export const TRANSLATIONS = {
  EN: {
    ...
    CONTINUE_CAREER: 'CONTINUE CAREER',
    START_NEW: 'START NEW',
    PROFILE: 'PROFILE',
    LOCAL_2P: 'LOCAL 2P',
    SETTINGS: 'SETTINGS',
    ...
    LOCAL_MATCH_SELECTION: 'Local Match Selection',
    BACK: 'BACK',
    ...
    GOALIE: 'GOALIE',
    FIRE: 'FIRE',
    MODS_LOCKED: 'Modes and Difficulty cannot be changed during career',
    MANAGER_PROFILE: 'Manager Profile',
    YOUR_MATCHWEEK: 'Your Matchweek',
    RESULTS_BREAKDOWN: 'Results Breakdown',
    PLAY_MATCH: 'PLAY MATCH',
    SIM_WEEK: 'Sim Week',
    NEXT_MATCHWEEK: 'NEXT MATCHWEEK',
    ...
    HISTORY_LOG: 'PAST SEASONS',
    POINTS: 'Points',
    FAN_SUPPORT: 'Fan Support',
    TROPHY_CABINET: 'Trophy Cabinet',
    NO_TROPHIES: 'No trophies won yet.',
    SEASON_CONCLUSION: 'Season Conclusion Reached',
    BACK_TO_MENU: 'BACK TO MENU',
    EXIT_CAREER: 'Exit Career',
    ...
    NAME_HINT: 'This name will appear on your manager profile card.',
    GAME_MODE: 'Game Mode',
    GOALIE_ON: 'Goalie On',
    GOALIE_OFF: 'Goalie Off',
    FIRE_MODE_ACTIVE: 'Fire Mode Active',
    ...
    RANK_HASH: 'RANK #',
    VIEW_TRANSFER_OFFERS: 'VIEW TRANSFER OFFERS',
    TRANSFER_MARKET: 'Transfer Market',
    STAY_AT_CLUB: 'Stay at Club',
    STAY_DESC: 'Continue your legacy with your current team.',
    STAY: 'STAY',
    OFFER_SUFFIX: 'OFFER',
    ...
    GOAL_EXCL: 'GOAL!',
    GAME_OVER: 'GAME OVER',
    SPACE_KICK: 'SPACE: KICK / SLIDE',
    ENTER_KICK: 'ENTER: KICK / SLIDE',
    ARROWS: 'ARROWS',
    L_SHIFT: 'L-SHIFT: SLOW',
    ...
    COST: 'COST',
    EST_MATCHES: 'EST. MATCHES',
    S_SPEED: 'SPEED',
    S_SHOOT: 'SHOOT',
    S_CONTROL: 'CONTROL',
    S_DEFENSE: 'DEFENSE',
    COST_INCREASED: 'COSTS INCREASED (TIER 4 UNLOCKED)',
    S_SPEED_DESC: 'Increases Max Speed',
    S_SHOOT_DESC: 'Increases Shot Power',
    S_CONTROL_DESC: 'Better Ball Control',
    S_DEFENSE_DESC: 'Slide & Recovery',
  },
  TR: {
    MATCH_TIME: 'Maç Süresi',
    TARGET_SCORE: 'Hedef Skor',
    BOT_DIFFICULTY: 'Bot Zorluğu',
    GAME_MODES: 'Oyun Modları',
    CONTINUE_CAREER: 'KARİYERE DEVAM',
    START_NEW: 'YENİ OYUN',
    PROFILE: 'PROFİL',
    LOCAL_2P: 'YEREL 2P',
    SETTINGS: 'AYARLAR',
    MANAGER_IDENTITY: 'MENAJER KİMLİĞİ',
    ENTER_NAME: 'Adınızı Girin',
    CANCEL: 'İPTAL',
    CONTINUE: 'DEVAM ET',
    CHOOSE_CLUB: 'Takım Seç',
    LOCAL_MATCH_SELECTION: 'Yerel Maç Seçimi',
    BACK: 'GERİ',
    SELECT_LEAGUE: 'Lig Seçimi',
    LANGUAGE: 'Dil',
    MUSIC: 'Müzik',
    ON: 'AÇIK',
    OFF: 'KAPALI',
    GOALIE: 'KALECİLİ',
    FIRE: 'ATEŞLİ',
    MODS_LOCKED: 'Modlar ve Zorluk kariyer sırasında değiştirilemez',
    MANAGER_PROFILE: 'Menajer Profili',
    YOUR_MATCHWEEK: 'Maç Haftanız',
    RESULTS_BREAKDOWN: 'Sonuçlar',
    PLAY_MATCH: 'MAÇI OYNA',
    SIM_WEEK: 'Haftayı Simüle Et',
    NEXT_MATCHWEEK: 'SONRAKİ HAFTA',
    LEAGUE_TABLE: 'Puan Durumu',
    SETTINGS_TAB: 'Ayarlar',
    CAREER_OVERVIEW: 'Kariyer Özeti',
    TOTAL_SEASONS: 'Toplam Sezon',
    TROPHIES_WON: 'Kazanılan Kupalar',
    ACHIEVEMENTS: 'Başarımlar',
    HISTORY_LOG: 'GEÇMİŞ SEZONLAR',
    POINTS: 'Puan',
    FAN_SUPPORT: 'Taraftar Desteği',
    TROPHY_CABINET: 'Kupa Müzesi',
    NO_TROPHIES: 'Henüz kupa kazanılmadı.',
    SEASON_CONCLUSION: 'Sezon Sonu',
    BACK_TO_MENU: 'MENÜYE DÖN',
    EXIT_CAREER: 'Kariyerden Çık',
    BIGGEST_WIN: 'En Farklı Galibiyet',
    BIGGEST_LOSS: 'En Farklı Mağlubiyet',
    GOALS: 'Goller',
    RECORD: 'İstatistik',
    MANAGER_SETTINGS: 'Menajer Ayarları',
    MANAGER_NAME: 'Menajer Adı',
    NAME_HINT: 'Bu isim menajer kartınızda görünecektir.',
    GAME_MODE: 'Oyun Modu',
    GOALIE_ON: 'Kaleci Açık',
    GOALIE_OFF: 'Kaleci Kapalı',
    FIRE_MODE_ACTIVE: 'Ateş Modu Aktif',
    FULL_TIME_RESULT: 'Maç Sonucu',
    MATCH_COMPLETED: 'MAÇ TAMAMLANDI',
    DRAW: 'Beraberlik',
    WINNER: 'Kazanan:',
    CONTINUE_TO_DASHBOARD: 'DEVAM ET',
    SEASON_COMPLETED: 'SEZON TAMAMLANDI',
    FINAL_PLACEMENT: 'Sezon Sıralaması',
    RANK_HASH: 'SIRA #',
    VIEW_TRANSFER_OFFERS: 'TRANSFER TEKLİFLERİ',
    TRANSFER_MARKET: 'Transfer Pazarı',
    STAY_AT_CLUB: 'Kulüpte Kal',
    STAY_DESC: 'Mevcut takımınla efsane olmaya devam et.',
    STAY: 'KAL',
    OFFER_SUFFIX: 'TEKLİFİ',
    SIGN_CONTRACT: 'SÖZLEŞME İMZALA',
    TBL_CLUB: 'Kulüp',
    TBL_PL: 'O',
    TBL_G: 'G',
    TBL_B: 'B',
    ...
    GOAL_EXCL: 'GOL!',
    GAME_OVER: 'MAÇ BİTTİ',
    SPACE_KICK: 'BOŞLUK: ŞUT / KAYMA',
    ENTER_KICK: 'ENTER: ŞUT / KAYMA',
    ARROWS: 'OK TUŞLARI',
    L_SHIFT: 'L-SHIFT: YAVAŞ',
    SKILL_TREE: 'YETENEK AĞACI',
    SKILLS: 'YETENEKLER',
    SKILL_POINTS: 'SKILL POINTS',
    SP: 'SP',
    MAX_REACHED: 'MAKSİMUM',
    COST: 'BEDEL',
    EST_MATCHES: 'ORT. MAÇ',
    S_SPEED: 'HIZ',
    S_SHOOT: 'ŞUT',
    S_CONTROL: 'KONTROL',
    S_DEFENSE: 'SAVUNMA',
    COST_INCREASED: 'BEDELLER ARTTI (SEVİYE 4 AÇILDI)',
    S_SPEED_DESC: 'Maksimum Hızı Artırır',
    S_SHOOT_DESC: 'Şut Gücünü Artırır',
    S_CONTROL_DESC: 'Top Hakimiyetini Artırır',
    S_DEFENSE_DESC: 'Kayma ve Toparlanma',
  }
};
